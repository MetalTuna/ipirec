...
from core import *
from ..models.ipirec_model_series1 import IPIRecModelSeries1


class IPIRecEstimatorSeries1(BaseTrain):
    """
    - 요약:
    ...
    # properties
    @property
    def model(self) -> IPIRecModelSeries1:
        return self._model
    ...
    def create_models_parameters(
        ...
        score_generalization: float = 10**-2,
        weight_iterations: int = 10,
        weight_learning_rate: float = 10**-2,
        weight_generalization: float = 10**-2,
        frob_norm: int = 1,
