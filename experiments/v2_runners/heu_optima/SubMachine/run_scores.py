...
[수정일]
- 24.06.04 12:41. 우선 가장 좋은 결과를 보인 모델구성 재현하기
...
RESULTS_SUMMARY_HOME = f"{WORKSPACE_HOME}/results/heuristics_optima/vlp_SubMachine"
""">>> `${WORKSPACE_HOME}`/results/heuristics_optima/vlp_SubMachine"""
...
if __name__ == "__main__":
    ...
    ## Opt. Rngs.
    top_n_tags_list = [20]
    score_iter_list = [n for n in range(10, 50, 10)]
