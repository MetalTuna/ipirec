...
""">>> `${WORKSPACE_HOME}`/data"""
RESULTS_SUMMARY_HOME = f"{WORKSPACE_HOME}/results/NMF/views"
""">>> `${WORKSPACE_HOME}`/results/NMF/views"""
MODEL_NAME = "NMF"
...
if __name__ == "__main__":
    ...
    # [24.05.10] Env.
    frob_norm_n = 1
    factors_dim_list = [100, 200, 300]  # [200, 250, 300]
    factors_iter_list = [
        i for i in range(100, 250, 50)
    ]  # [iter for iter in range(200, 400, 50)]
    learning_rate_list = [
        0.001,
    ...
    generalizations_list = [
        0.001,
        0.0001,
    ]  # [g * 0.1 for g in learning_rate_list]
    train_iterations_list = [i for i in range(40, 160, 20)]  # [30, 50, 100, 150]
    """

    # [24.05.20] Env.
    frob_norm_n = 1
    factors_dim_list = [200]
    factors_iter_list = [200]
    learning_rate_list = [0.0001]
    generalizations_list = [0.00001]
    train_iterations_list = [120]
