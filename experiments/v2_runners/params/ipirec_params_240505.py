...
if __name__ == "__main__":
    ...
    score_learning_rate_list = [0.5, 0.1, 0.05, 0.01, 0.005, 0.001]
    """
    ...
    """
    score_iterations_list: list = [n for n in range(10, 40, 10)]
    weight_iterations_list = [n for n in range(30, 90, 10)]
    weight_learning_rate_list = [0.5, 0.1, 0.05, 0.01, 0.005, 0.001]
    """
    ...
    """
    weight_generalizations_list = [g * 0.1 for g in weight_learning_rate_list]
