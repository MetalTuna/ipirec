...
if __name__ == "__main__":
    ...
    # [24.05.10] Env.
    frob_norm_n = 1
    factors_dim_list = [200, 300]  # [150, 200, 250, 300]
    factors_iter_list = [
        i for i in range(80, 240, 40)
    ...
    train_iterations_list = [
        i for i in range(40, 90, 10)
    ]  #  [i for i in range(40, 200, 40)]
    """
    ...
    generalizations_list = [0.001]
    train_iterations_list = [150]
