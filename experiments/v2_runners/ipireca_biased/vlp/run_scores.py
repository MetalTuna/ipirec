...
[수정일] 
- 24.05.28 10:44. 점수보정 효과가 전혀 없음, 모델변수범위 재탐색 (3090)
...
if __name__ == "__main__":
    """
    ### [24.05.27] Obs. >> adjust tags score [iter_s, lambda_s, gamma_s]
    ## Opt. Rngs.
    top_n_tags_list = [40]
    score_iter_list = [3, 6, 9]
    score_learing_rate_list = [0.0001, 0.00001, 0.000001]
    score_generalization_list = [0.001, 0.0001, 0.00001]
    weight_iter_list = [5]
    ...
    """
    ### [24.05.28] Obs. >> adjust tags score [lambda_s, gamma_s] - 3090
    ##
    top_n_tags_list = [10]
    score_iter_list = [3]
    score_learing_rate_list = [0.1, 0.01, 0.001]
    score_generalization_list = [0.1, 0.01, 0.001]
    weight_iter_list = [5]
    weight_learning_rate_list = [0.001]
    weight_generalization_list = [1.0]
    dv_score_list = [0.0]
    ...
    """
    """
    ### [24.05.29] Obs. >> tags_score - SubMachine
    ## Opt. Rngs.
    top_n_tags_list = [20]
    score_iter_list = [3, 5]
    score_learing_rate_list = [0.1, 0.01, 0.001]
    score_generalization_list = [0.01, 0.001, 0.0001]
    weight_iter_list = [5]
    weight_learning_rate_list = [0.001]
    weight_generalization_list = [1.0]
    dv_score_list = [0.0]
    ...
    """
    """
    ### [24.05.30] Obs. Args ratio (l=100:r=1)>> tags_score - 3090
    ## Opt. Rngs.
    score_args_ratio = 1 / 100
    top_n_tags_list = [20]
    score_iter_list = [3, 5]
    score_learing_rate_list = [0.1, 0.01, 0.001]
    score_generalization_list = [g * score_args_ratio for g in score_learing_rate_list]
    # score_generalization_list = [0.01, 0.001, 0.0001]
    weight_iter_list = [5]
    weight_learning_rate_list = [0.001]
    weight_generalization_list = [1.0]
            ...
            for co_occur_items in co_occur_items_list:
                for score_iterations in score_iter_list:
                    for score_learning_rate in score_learing_rate_list:
                        ...
                        score_generalization = score_learning_rate * score_args_ratio
                        for weight_iteration in weight_iter_list:
                            for weight_learning_rate in weight_learning_rate_list:
                                for weight_generalization in weight_generalization_list:
