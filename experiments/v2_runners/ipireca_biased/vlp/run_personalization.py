...
[수정일] 
- 24.06.02 14:41. 경험적 접근 (DEBUG && Heuristics approach)
...
""">>> `${WORKSPACE_HOME}`/data"""
MODEL_NAME = "IPIRecAB_Personalization"
RESULTS_SUMMARY_HOME = f"{WORKSPACE_HOME}/results/debug/vlp_rev_S_ps0"
"""
Pinpoint CVSet-0 Obs. GD. Iters.
>>> `${WORKSPACE_HOME}`/results/debug/vlp_rev_S_ps0
"""
...
def build_models(
    ...
    for k in range(KFold):
        ...
        model.analysis()
        estimator_params = (
            AdjustedBiasedCorrelationApproxEstimator.create_models_parameters(
        ...
        estimator = AdjustedBiasedCorrelationApproxEstimator(
            model=model,
...
if __name__ == "__main__":
    """
    ### [24.05.27] Obs. >> ex. training [iter_w, lambda_w, gamma_w]
    ## Opt. Rngs.
    top_n_tags_list = [40]
    score_iter_list = [3]
    score_learing_rate_list = [0.0001]
    score_generalization_list = [0.001]
    weight_iter_list = [5, 10, 15, 20]
    weight_learning_rate_list = [0.001, 0.0001, 0.00001, 0.000001]
    weight_generalization_list = [1.0, 0.1, 0.01]
    dv_score_list = [0.0]
    co_occur_items_list = [4]
    frob_norm_list = [1]
    """

    ### [24.06.02] Obs. >> personalization - LOCAL
    """
    ## Opt. Rngs.
    top_n_tags_list = [10]
    score_iter_list = [30]
    score_learing_rate_list = [10 ** (-1 * 5)]
    score_generalization_list = [10 ** (-1 * 6)]
    weight_iter_list = [10]
    weight_learning_rate_list = [10 ** (-1 * 2)]
    ...
    ### [24.06.02] Obs. >> personalization - DEBUG
    top_n_tags_list = [10]
    score_iter_list = [1]
    score_learing_rate_list = [10 ** (-1 * 5)]
    score_generalization_list = [10 ** (-1 * 6)]
    weight_iter_list = [1, 3]
    weight_learning_rate_list = [10 ** (-1 * 2)]
    weight_generalization_list = [1.0]
    dv_score_list = [0.0]
    co_occur_items_list = [4]
