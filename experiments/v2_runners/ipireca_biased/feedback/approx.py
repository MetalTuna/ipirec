...
[수정일]
- 24.05.27 15:59. 모델 피드백 변경관찰을 위한 수정 (수정된 모듈 실행)
...
""">>> `${WORKSPACE_HOME}`/data"""
MODEL_NAME = "IPIRecAB_Approx_Feedback"
RESULTS_SUMMARY_HOME = f"{WORKSPACE_HOME}/results/feedback"
""">>> `${WORKSPACE_HOME}`/results/feedback"""
...
if __name__ == "__main__":
    ### [24.05.27] Obs. >> ex. NT(u)
    ## Opt. Rngs.
    top_n_tags_list = [10]
    score_iter_list = [5]
    weight_iter_list = [5]
    score_learing_rate_list = [0.001]  # [0.00001]
    score_generalization_list = [0.01]  # [0.0001]
