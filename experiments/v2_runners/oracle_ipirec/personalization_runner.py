...
MODEL_NAME = "IPIRec"
"""Obs."""
RESULTS_SUMMARY_HOME = f"{WORKSPACE_HOME}/results/{__COMP_DATE_STR__}/personalizations"
""">>> `${WORKSPACE_HOME}`/results/`YYYYMMDD`/personalizations"""
...
if __name__ == "__main__":
    ...
    ## Score OPT.
    score_iter_list = [10]
    score_learing_rate_list = [10 ** (-1 * 2)]
    score_generalization_list = [10 ** (-1 * 4)]

    ## Per. OPT.
    weight_iter_list = [5]
    weight_learning_rate_list = [10 ** (-1 * 1)]
    ...
    weight_iter_list = [n for n in range(10, 50, 10)]
                                ...
                                for weight_generalization in weight_generalization_list:
                                    for default_voting_score in dv_score_list:
                                        ...
                                        build_models(
                                            ...
                                            weight_learning_rate=weight_learning_rate,
                                            weight_generalization=weight_generalization,
                                            decision_type_seq_list=dtype_seq_list,
                                        )
                                    # end : for (DV_scores)
                                # end : for (W_gamma)
                            # end : for (W_lambda)
