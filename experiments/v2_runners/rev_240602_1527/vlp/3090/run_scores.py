...
RESULTS_SUMMARY_HOME = f"{WORKSPACE_HOME}/results/rev_240602/params/vlp_3090"
""">>> `${WORKSPACE_HOME}`/results/params/vlp_3090"""
...
if __name__ == "__main__":
    ### [24.05.31] Obs. >> tags_score - SubMachine
    ## Opt. Rngs.
    top_n_tags_list = [10]
    score_iter_list = [n for n in range(20, 90, 10)]
    score_learing_rate_list = [10 ** (-1 * n) for n in range(4, 8, 1)]
