...
if __name__ == "__main__":
    ### [24.06.03] Obs. >> personalization - SubMachine
    ## Opt. Rngs.
    top_n_tags_list = [10]
    score_iter_list = [40]
    score_learing_rate_list = [10 ** (-1 * 7)]
    score_generalization_list = [10 ** (-1 * 8)]
    weight_iter_list = [n for n in range(40, 70, 10)]
    weight_learning_rate_list = [0.1, 0.01, 0.001]
