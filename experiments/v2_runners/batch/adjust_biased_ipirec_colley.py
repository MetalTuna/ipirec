...
""">>> `${WORKSPACE_HOME}`/data"""
MODEL_NAME = "BiasedIPIRecA"
RESULTS_SUMMARY_HOME = f"{WORKSPACE_HOME}/results/observ"
""">>> `${WORKSPACE_HOME}`/results/observ"""
...
if __name__ == "__main__":
    ...
    """
    # Machine: 3090
    top_n_tags_list = [n for n in range(10, 60, 10)]
    score_iter_list = [10, 30, 50]
    weight_iter_list = [10, 30]
    score_learing_rate_list = [0.0001]
    weight_learning_rate_list = [0.0001]
    ...
    top_n_tags_list = [n for n in range(10, 60, 10)]
    score_iter_list = [10, 30, 50]
    weight_iter_list = [50, 70, 90]
    score_learing_rate_list = [0.00001]
    weight_learning_rate_list = [0.00001]
    ...
    """
    ## [24.05.22 16:02] SubMachine
    top_n_tags_list = [n for n in range(10, 60, 10)]
    score_iter_list = [10, 30, 50]
    weight_iter_list = [n for n in range(10, 90, 20)]
    score_learing_rate_list = [0.001, 0.0001]
    weight_learning_rate_list = [0.001, 0.0001]
    score_generalization_list = [0.01, 0.001]
    weight_generalization_list = [0.1, 0.01]
    dv_score_list = [0.0, 0.1]
    co_occur_items_list = [4]
    frob_norm_list = [1]
    """
    ...
    """
    ## [24.05.22 19:30] 3090
    top_n_tags_list = [n for n in range(10, 70, 10)]
    score_iter_list = [10, 30, 50]
    weight_iter_list = [10]
    weight_iter_list.extend([n for n in range(50, 250, 50)])
    score_learing_rate_list = [0.0001, 0.00001]
    score_generalization_list = [0.001, 0.0001]
    weight_learning_rate_list = [0.0001, 0.00001]
    weight_generalization_list = [0.01, 0.001]
    dv_score_list = [0.0, 0.1]
    co_occur_items_list = [4]
    frob_norm_list = [1]
    """

    ## [24.05.24 17:00] SubMachine
    top_n_tags_list = [n for n in range(30, 70, 10)]
    score_iter_list = [3]
    weight_iter_list = [5]
    score_learing_rate_list = [0.0001, 0.00001]
    score_generalization_list = [0.0001, 0.00001, 0.000001]
    weight_learning_rate_list = [0.0001, 0.00001]
    weight_generalization_list = [0.1, 0.01, 0.001]
    dv_score_list = [0.0]
    co_occur_items_list = [4]
    frob_norm_list = [1]
