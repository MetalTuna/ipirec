...
if __name__ == "__main__":
    ...
    with open(
        ...
        # IRMetrics HEADER
        fout_ir.write("set_no,top-n,decision_type,f1-score,hits\n")
        fout_ts.write("set_no,observ,decision_type,rmse,hits\n")
        fout_td.write("set_no,decision_type,distance\n")
        ...
        for file_name in os.listdir(_BIN_REC_DIR_PATH):
            ...
            _KFOLD_NO = int(file_name.split("_")[0].strip())
            print(file_path)
