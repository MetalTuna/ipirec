...
[수정일]
- 24.06.26. Rev3 TestCase3. 점수계산 학습관련 사항들이 모두 변경됨
    - 참고: /colleykr/24-06-26-2ef200c432e54fb28d364c72e7324598?pvs=4
    - 구성: vlp_v
"""
...
if __name__ == "__main__":
    ## Model Args.
    BIN_DUMP_DIR_PATH = f"{RESOURCES_DIR_HOME}/test_case_3"
    ...
    _estimator.train(
        ...
        BIN_DUMP_DIR_PATH=BIN_DUMP_DIR_PATH,
    )
