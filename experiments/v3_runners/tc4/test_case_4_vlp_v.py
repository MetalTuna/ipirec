...
[수정일]
- 24.06.27 11:30. Rev3 TestCase4. TestCase3의 학습과정에 경향성 축을 가하는 작업이 추가됨.
    - 구성: vlp_v
"""
...
RESOURCES_DIR_HOME = f"{BIN_INSTANCES_HOME}/resources/test_case_4"
""">>> `${BIN_INSTANCES_HOME}`/resources/test_case_4"""
