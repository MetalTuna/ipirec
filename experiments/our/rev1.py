...
from core import *
from colley import *
from ipirec import IPIRecModelSeries1, IPIRecEstimatorSeries1
...
def recommendation(
    ...
    _estimator: IPIRecEstimatorSeries1 = load_estimator(binary_estimator_file_path)
    _fit_estimator: IPIRecEstimatorSeries1 = None
    _loss_list = list()
    ...
    while True:
        ...
        if min(_loss_list) < _L:
            ...
            if _fit_estimator != None:
                _estimator: IPIRecEstimatorSeries1 = _fit_estimator
            break
        if min(_loss_list) > _L:
            _fit_estimator: IPIRecEstimatorSeries1 = copy.deepcopy(_estimator)
