...
if __name__ == "__main__":
    ...
    similarity_file_path = f"{dump_dir_path}/item_pcc_colley.bin"
    dataset_dir_path = f"{WORKSPACE_HOME}/data/colley"
    testset_file_path = f"{dataset_dir_path}/like_list.csv"
    results_summary_path = f"{WORKSPACE_HOME}/results/item_cf_colley_TopN_IRMetrics.csv"
    ...
    file_path = f"{WORKSPACE_HOME}/results/predicted_scores_colley.bin"
