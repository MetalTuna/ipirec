...
if __name__ == "__main__":
    ...
    for k in range(KFold):
        ...
        model_params = BiasedCorrelationEstimator.create_models_parameters(
            ...
            score_learning_rate=learning_rate,
            score_generalization=generalization,
            weight_iterations=weight_iter,
            weight_learning_rate=learning_rate,
            weight_generalization=generalization,
            frob_norm=frob_norm,
        ...
        estimator.adjust_tags_score()
        # estimator._adjust_tags_corr_()
