...
if __name__ == "__main__":
    ...
    cpy_time_str = "1853"
    """HHMM"""
    # train_dtype_seq_str = "vp"
    # machine_name_str = "3090"
    # module_name_str = "Baseline"
    module_name_str = "Pinpoint"
    conditions_case_no = 3
    _conditions_label_str = f"test_case_{conditions_case_no}"

    results_home_path = str.format(
        "{0}/results/{1}/{2}/{3}",  # {3}_{4}/{5}",
        WORKSPACE_HOME,
        _datestr,
        cpy_time_str,
        _conditions_label_str,
        # train_dtype_seq_str,
        # machine_name_str,
        # module_name_str,
    )
    # /Users/taegyu.hwang/Documents/tghwang_git_repo/ipirec/results/20240611/1853/test_case_1/IPIRec
