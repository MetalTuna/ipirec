...
if __name__ == "__main__":
    ...
    _BASE_DIR_PATH = f"{WORKSPACE_HOME}/results/20240618/1600"
    # model_name_str = "IPIRec_3090"
    model_name_str = "IPIRec_SubMachine"
    # model_name_str = "Personalization_3090"
    RESULTS_DIR_PATH = f"{_BASE_DIR_PATH}/{model_name_str}"
    workbook_file_path = f"{_BASE_DIR_PATH}/IPIRec_results.xlsx"
